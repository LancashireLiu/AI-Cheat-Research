...
def timegan (ori_data, parameters):
  ...
  embedding_iterations = 3500
  for itt in range(embedding_iterations):
    # Set mini-batch
    ...
    # Checkpoint
    if itt % 10 == 0:
      print('step: '+ str(itt) + '/' + str(embedding_iterations) + ', e_loss: ' + str(np.round(np.sqrt(step_e_loss),4)) )
      
  print('Finish Embedding Network Training')
    
  # 2. Training only with supervised loss
  print('Start Training with Supervised Loss Only')
  supervised_iterations = 7000
  for itt in range(supervised_iterations):
    # Set mini-batch
    X_mb, T_mb = batch_generator(ori_data, ori_time, batch_size)    
    ...
    # Checkpoint
    if itt % 10 == 0:
      print('step: '+ str(itt)  + '/' + str(supervised_iterations) +', s_loss: ' + str(np.round(np.sqrt(step_g_loss_s),4)) )
      
  print('Finish Training with Supervised Loss Only')
    
  # 3. Joint Training
  print('Start Joint Training')
  joint_iterations = 5000
  for itt in range(joint_iterations):
    ...
    if itt % 10 == 0:
      print('step: '+ str(itt) + '/' + str(joint_iterations) +
